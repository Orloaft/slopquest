...
const ts = 32;
const dir = nodePath.join(repoRoot, "assetsources/asset-forge/exports/route");
const stage = JSON.parse(readFileSync(nodePath.join(dir, "route.stage.json"), "utf8"));
...
const outPath = nodePath.join(repoRoot, "artifacts/route-from-stage.png");
